...
<body>
			...
			<div class="col">
				...
				<form id="form1" action="${appRoot }/board/modify" method="post">
					...
					<div>
						...
						<textarea class="form-control" name="body" id="textarea1" cols="30"
							rows="10" readonly>${board.body }</textarea>
					</div>
					...
					<c:forEach items="${replyList }" var="reply">
						<li class="list-group-item">
							...
							<div id="replyDisplayContainer${reply.id }">						
								<div class="fa-bold"><i class="fa-solid fa-comment"></i>${reply.prettyInserted }</div>
								${reply.content }
							...
							<div id="replyEditFormContainer${reply.id }" style="display : none">
								<form action="${appRoot }/reply/modify" method="post">
									<div class="input-group">				
										...
										<input class="form-control" type="text" value="${reply.content }" name="replyContent" required />
	...
	<div class="d-none">
		<form id="replyDeleteForm1" action="${appRoot }/reply/delete" method="post">
			...
			<input id="replyDeleteBoardId" type="text" name="boardId"  value="${board.id }"/>
		</form>
	</div>
